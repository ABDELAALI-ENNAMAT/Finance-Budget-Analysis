...
GO
/*
View that shows total monthly revenues per department and category.
*/
...
GO
/*
View that shows total revenue, total expense, net profit, and transaction counts per department.
*/
...
GO
/*
View that lists the departments with the highest total expenses in the last 12 months.
*/
...
GO
/*
View that calculates the monthly profit growth rate per department.
*/
...
GO
/*
View that shows yearly total revenue, expense, and net profit per department.
*/
